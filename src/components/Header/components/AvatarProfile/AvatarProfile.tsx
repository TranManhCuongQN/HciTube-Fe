  ...
  return (
    <>
      ...
      >
        ...
        {isShow && (
          <div className='absolute top-11 right-0 flex w-[250px] flex-col justify-start rounded-xl bg-[#ffffff] drop-shadow-md dark:bg-[#282828] '>
            <div className='flex items-center gap-x-5 border-b-2 border-gray-400 p-4'>
            ...
            <Link
              to={path.profile}
              className='flex items-center gap-x-6  px-4 py-3 hover:bg-[#E5E5E5] dark:hover:bg-[#303030]'
            >
              <AiOutlineProfile className=' h-6 w-6 text-black dark:text-white ' />
            ...
            <Link
              ...
              className='flex items-center gap-x-6  px-4 py-3 hover:bg-[#E5E5E5] dark:hover:bg-[#303030]'
            >
              <CgWindows className=' h-6 w-6 text-black dark:text-white ' />
            ...
            <Link
              ...
              className='flex items-center gap-x-6  px-4 py-3 hover:bg-[#E5E5E5] dark:hover:bg-[#303030]'
            >
              <BsBarChartLineFill className=' h-6 w-6 text-black dark:text-white' />
            ...
            <Link
              ...
              className='flex items-center  gap-x-6 px-4 py-3 hover:bg-[#E5E5E5] dark:hover:bg-[#303030]'
            >
              <RiLockPasswordLine className=' h-6 w-6 text-black dark:text-white ' />
              <span className='text-sm font-medium text-black dark:text-white'>Đổi mật khẩu</span>
            </Link>

            <button
              className='mb-5 flex items-center  gap-x-6 px-5 py-3 hover:bg-[#E5E5E5] dark:hover:bg-[#303030]'
              onClick={handleExit}
            >
              <ImExit className=' h-6 w-6 text-black dark:text-white ' />
