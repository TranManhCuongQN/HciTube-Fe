    ...
    <>
      <div className='container flex flex-col gap-y-5 bg-[#f9f9f9] pl-3 pr-3 pb-3 dark:bg-[#1f1f1f] lg:h-screen lg:flex-row lg:gap-x-8'>
        ...
        <div className='flex flex-col gap-y-2 lg:mt-4 lg:gap-y-5'>
          ...
          <div className='flex flex-col gap-y-5 gap-x-5 bg-[#f9f9f9] dark:bg-[#1f1f1f] dark:shadow-2xl lg:flex-row lg:gap-x-5'>
      ...
      <DialogCustom isOpen={isModalOpen} handleClose={handleCloseModal} className='bg-black'>
