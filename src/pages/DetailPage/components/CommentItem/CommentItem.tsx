      ...
      <div className='my-3 flex flex-col '>
        ...
        <div className='mt-3 flex items-center gap-x-2'>
          ...
          <div className='flex flex-grow flex-col gap-y-3'>
            <textarea
              className='h-8 w-full border-b border-b-black bg-transparent p-2 text-xs text-black outline-none placeholder:text-xs placeholder:font-semibold placeholder:text-gray-400 dark:border-b-white dark:text-white md:h-10 md:text-sm'
